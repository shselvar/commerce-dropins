...
- Preview: https://main--commerce-dropins--shselvar.hlx.page/
- Live: https://main--commerce-dropins--shselvar.hlx.live/
...
1. Open the `commerce-dropins` directory in your favorite IDE and start coding :)
